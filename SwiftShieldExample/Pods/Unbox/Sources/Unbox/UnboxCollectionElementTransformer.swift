...
public protocol jCqsSUKEFMkUKmLYzSUHhLijcuHlxnfT {
    ...
    func MsZnnKcxLfDXfoybNFYgGpeGaDCXEprk(element: UnboxRawElement, allowInvalidCollectionElements: Bool) throws -> UnboxedElement?
}
